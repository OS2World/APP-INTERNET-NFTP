...
; Unix:
;;transfer-complete-action="echo download complete | /bin/mail `whoami`"
...
;
;preserve_permissions_download=yes
...
; whether to guess the cyrillic charset for displaying file descriptions
; and when viewing files. this has only effect on display; actual write
; of descriptions/files is unaffected! default: yes
;
;guess-cyrillic-charsets=yes


; whether to write control connection protocol. it is mostly used
; for bug reporting purposes. default: no
;
;log-control-connection=no


; should FXP transfers always skip files and don't try to resume/overwrite
; default: no

;fxp-always-skips=no

; interval between automatic refresh of remote directory, in seconds.
; 0 means that autorefresh is disabled. default: 0

;auto-refresh=0


; custom selection mask. used to mark files to be transferred in custom
; action 1 and 2. default: "*.zip"

;custom-selection-mask="*.zip"


; whether to change into subdirectory after creating. default: no

;enter-subdir-after-create=no
...
; whether to show server name at the top of the panel
; default: yes

;show-server-name=yes


; whether to display column headings on the panels
; default: yes

;show-panel-headings = yes
...
;SP-description=12
;SP-file-marked=1e
;SP-directory-marked=1e
;SP-description-marked=12
;SP-file-pointer=30
;SP-directory-pointer=30
;SP-description-pointer=32
;SP-file-marked-pointer=3e
;SP-directory-marked-pointer=3e
;SP-description-marked-pointer=32

; ----- Files (two-panel mode)
...
; status line (default: black on white)
;
;status2=70
