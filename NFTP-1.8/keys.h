...
#define KEY_REVIEW_MARKED                     12 // review list of marked files
...
//
#define KEY_GEN_CHANGE_TRANSFER_MODE          21 // switch ASCII/BINARY
...
#define KEY_SYNC_OPTIONS                      59 // set default mirroring options
...
#define KEY_FM_COPY                           77 // copy file(s)/directory
#define KEY_FM_MOVE                           78 // move file(s)/directory
